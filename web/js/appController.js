...
/*           { path: 'createInduction', detail : {label: 'Create Induction',iconClass: 'oj-navigationlist-item-icon fa fa-calendar',dep_url : self.onepDepUrl,dep_type : self.onepDepType} },
 */        ];
      }
      ...
      if(sessionStorage.getItem('userRole')=='staff'){
        ...
        self.navDataProvider = new ArrayDataProvider(navData.slice(6), {keyAttributes: "path"});
      }
