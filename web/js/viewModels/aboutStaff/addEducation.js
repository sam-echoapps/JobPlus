                        ...
                        success: function (result) {
                            ...
                            console.log(data.length)
                              ...
                              for (var i = 0; i < data.length; i++) {
                                if(data[i][7]){
                                self.EducationDet.push({'id': data[i][0], 'staff_id' : data[i][1], 'institution_name' : data[i][2] , 'qualification' : data[i][3] , 'from_date' :data[i][4] , 'to_date' : data[i][5], 'certificate' : data[i][7] }); 
                                }else{
