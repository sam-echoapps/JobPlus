...
function (oj,ko,$, app, ArrayDataProvider) {
    ...
    class Induction {
        constructor(context) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data.length==0){
                            ...
                            if(data[0][18] == "Pending") {
                                self.starterStatus('Pending');
                            }else if(data[0][18] == "Audited") {
            ...
            self.updateStarterStatus = function (event,data) {
                var BaseURL = sessionStorage.getItem("BaseURL")
                $.ajax({
                    url: BaseURL+ "/jpStaffUpdateStarterStatus",
                    type: 'POST',
                    data: JSON.stringify({
                        staffId : sessionStorage.getItem("staffId"),
                    ...
                    success: function (data) {
                       console.log("Success")
                       if(sessionStorage.getItem('starter_status')=="Pending"){
                        sessionStorage.setItem('starter_status','Audited');
                       }else if(sessionStorage.getItem('starter_status')=="Audited"){
                        sessionStorage.setItem('starter_status','Pending');
                       }
                       location.reload();
                    }
                })  
